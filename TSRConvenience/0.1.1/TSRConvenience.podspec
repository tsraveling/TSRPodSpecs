#
#  Be sure to run `pod spec lint TSRConvenience.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "tsraveling" => "tsraveling@gmail.com" }
  # Or just: s.author    = "tsraveling"
  # s.authors            = { "tsraveling" => "tsraveling@gmail.com" }
  s.social_media_url   = "http://twitter.com/nomadico"
  ...
  s.source       = { :git => "https://github.com/tsraveling/TSRConvenience.git", :tag => "#{s.version}" }
